...
- `MICROSOFT_CLIENT_ID`, `MICROSOFT_CLIENT_SECRET` (required for Office 365 sync)
- `MICROSOFT_TENANT_ID` (optional; default `organizations`)
- `MICROSOFT_USER_EMAIL` (optional; helps prefill sign-in)
